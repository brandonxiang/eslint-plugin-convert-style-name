      ...
      JSXAttribute: (node) => {
        ...
        if (node.name.name === "styleName") {
          ...
          if (jsxAttributeValue.type === "Literal") {
            replaceCodeClassNames = strToClassNames(jsxAttributeValue.value);
          }
          ...
          if (jsxAttributeValue.type === "JSXExpressionContainer") {
            ...
            if (
              ...
              replaceCodeClassNames = `styles[${context
                .getSourceCode()
                .getText(jsxAttributeValue.expression)}]`;
            }
            ...
            if (expression.type === "ConditionalExpression") {
              ...
              if (
                ...
                const consequentCode = strToClassNames(
                  context.getSourceCode().getText(consequent)
                );
                const alternateCode = strToClassNames(
                  context.getSourceCode().getText(alternate)
                );
